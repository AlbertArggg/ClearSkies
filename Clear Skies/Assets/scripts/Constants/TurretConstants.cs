public class TurretConstants
{
    ...
    private const float DEFAULT_HORIZONTAL_CLAMP_MIN_VALUE = -45f;
    private const float DEFAULT_HORIZONTAL_CLAMP_MAX_VALUE = 45f;
    private const float DEFAULT_VERTICAL_CLAMP_MIN_VALUE = -45f;
    private const float DEFAULT_VERTICAL_CLAMP_MAX_VALUE = 45f;
